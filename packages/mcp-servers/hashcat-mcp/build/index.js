...
Note: GPU acceleration is not available in Docker without --gpus flag. CPU cracking is slower but functional.`, {
    ...
    wordlist: zod_1.z.string().optional().describe("Path to wordlist for dictionary/hybrid attacks. If unsure, use the wordlist plugin's tools — wordlist_recommend(purpose='password attack') for a recommended path, wordlist_search to find specific lists."),
