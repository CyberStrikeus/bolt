...
server.tool("do-smuggler", "Run Smuggler to detect HTTP Request Smuggling vulnerabilities", {
    url: zod_1.z.string().url().describe("Target URL to detect HTTP Request Smuggling"),
    smuggler_args: zod_1.z.array(zod_1.z.string()).optional().describe(`Additional smuggler arguments
    ...
    let output = '';
    const smuggler = (0, child_process_1.spawn)(args[0], allArgs);
