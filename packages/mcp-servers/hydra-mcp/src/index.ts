...
`,
    {
        ...
        login_file: z.string().optional().describe("Path to file containing usernames to test, one per line (e.g., /usr/share/seclists/Usernames/top-usernames-shortlist.txt)."),
        password: z.string().optional().describe("Single password to test. Use password_file to test a wordlist."),
        password_file: z.string().optional().describe("Path to password wordlist, one per line (e.g., /usr/share/seclists/Passwords/Common-Credentials/10-million-password-list-top-1000.txt)."),
