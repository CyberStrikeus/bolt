...
Common formats: auto (default), md5crypt, sha512crypt, bcrypt, nt, lm, raw-md5, raw-sha1, raw-sha256, zip, ssh`, {
    ...
    wordlist: zod_1.z.string().optional().describe("Path to wordlist for dictionary attack. If omitted, John uses incremental mode. If unsure, use the wordlist plugin's tools — wordlist_recommend(purpose='password attack') for a recommended path, wordlist_search to find specific lists."),
